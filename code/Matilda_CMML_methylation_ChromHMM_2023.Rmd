...
- <h style="color:red">added additional dataset for DMPs with LFC>0.3 according to the diaacusion on Tuesday 09.19</h>
...
ENCFF072SCA.bed[!seqnames(ENCFF072SCA.bed) %in% paste0("chr", unique(DMP_data$CHR))] %>% as.data.frame() %>%  dplyr::select(name) %>% table()
```
...
DMR_enhancer.set01$attributes <- gsub("genehancer_id=|connected_gene=|score=", "", DMR_enhancer.set01$attributes)
...
DMR_enhancer.set02$attributes <- gsub("genehancer_id=|connected_gene=|score=", "", DMR_enhancer.set02$attributes)
...
HyperMethyled_in_enhancers$attributes <- gsub("genehancer_id=|connected_gene=|score=", "", HyperMethyled_in_enhancers$attributes)
...
LFC3_HyperMethyled_in_enhancers$attributes <- gsub("genehancer_id=|connected_gene=|score=", "", LFC3_HyperMethyled_in_enhancers$attributes)

head(LFC3_HyperMethyled_in_enhancers)
